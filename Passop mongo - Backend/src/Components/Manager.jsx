...
const Manager = () => {
    ...
    const DeletePassowrd = async(id) => {
        let conform = confirm("Do you want to delete?")
        if (conform) {
            setpasswordArray(passwordArray.filter((item) => { return item.id !== id }))
            await fetch("https://localhost:3000/", {method:"DELETE", headers:{"Content-Type" : "application.json"}, body:JSON.stringify({id})})
                            ...
                            <tbody className='bg-green-100'>
                                {passwordArray.map((item, index) => {
                                    return <tr key={index}>
                                        ...
                                        <td className='text-center py-2 border font-semibold border-white'>
                                        ...
                                        <td className='text-center py-2 border border-white'>
                                            <div className='items-center font-semibold justify-center gap-2 flex flex-row'>
                                        ...
                                        <td className='text-center py-2 border border-white'>
                                            <div className='items-center font-bold justify-center gap-2 flex flex-row'>
